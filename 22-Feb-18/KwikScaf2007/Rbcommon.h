...
*
* $Version: $
* $Archive: /Meccano/Stage 1/Code/Rbcommon.h $
* $Revision: 2 $
* $Header: /Meccano/Stage 1/Code/Rbcommon.h 2     19/05/00 12:03p Jsb $
* $Author: Jsb $
* $Date: 19/05/00 12:03p $
*
* $History: Rbcommon.h $
 * 
 * *****************  Version 2  *****************
 ...
 * 
 * *****************  Version 1  *****************
 * User: Dar          Date: 1/10/99    Time: 1:22p
 * Created in $/Meccano/Stage 1/Code
 * 
 * *****************  Version 1  *****************
 * User: Dar          Date: 1/10/99    Time: 12:28p
 * Created in $/Meccano/Stage 1/Samples
* 
* *****************  Version 2  *****************
