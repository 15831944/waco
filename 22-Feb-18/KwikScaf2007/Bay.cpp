...
void Bay::SetGlobalValuesToDefault()
{
	...
	SetPreviousLength2( GetBayLength() );
...
void Bay::SetPreviousLength2( double dLength )
{
...
SideOfBayEnum Bay::FindInvalidRoofProtectionStandards( ) const
{
	...
	//Does thiseInvalidSide; bay have roof protection?
