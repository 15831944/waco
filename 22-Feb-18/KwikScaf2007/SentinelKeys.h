...
/*Core obj public interfaces*/
 ...
 /*SP_EXPORT SP_STATUS SP_API SFNTGetLicense(SP_IN SP_DWORD	devID, 
										  SP_IN SPP_BYTE	softwareKey, 
										  SP_IN SP_DWORD	licID, 
										  SP_IN SP_DWORD	flags,  
										  SP_IO SP_HANDLE	licHandle);*/


SP_EXPORT SP_STATUS SP_API SFNTQueryFeature(SP_IN SP_HANDLE licHandle, 
...
SP_EXPORT SP_STATUS SP_API SFNTReadString(SP_IN SP_HANDLE	licHandle, 
										  SP_IN SP_DWORD	featureID, 
										  SP_OUT SPP_CHAR	string, 
										  SP_IN SP_DWORD	stringLength);

SP_EXPORT SP_STATUS SP_API SFNTWriteString(SP_IN SP_HANDLE	licHandle, 
										   SP_IN SP_DWORD	featureID, 
										   SP_IN SPP_CHAR	string, 
										   SP_IN SP_DWORD	writePassword);

SP_EXPORT SP_STATUS SP_API SFNTReadInteger(SP_IN SP_HANDLE	licHandle, 
										   SP_IN SP_DWORD	featureID, 
										   SP_OUT SPP_DWORD value);

SP_EXPORT SP_STATUS SP_API SFNTWriteInteger(SP_IN SP_HANDLE licHandle, 
											SP_IN SP_DWORD	featureID, 
											SP_IN SP_DWORD	value, 
											SP_IN SP_DWORD	writePassword);

SP_EXPORT SP_STATUS SP_API SFNTReadRawData(SP_IN SP_HANDLE	licHandle, 
										   SP_IN SP_DWORD	featureID, 
										   SP_OUT SPP_VOID	buffer, 
										   SP_IN SP_DWORD	offset, 
										   SP_IN SP_DWORD	length);

SP_EXPORT SP_STATUS SP_API SFNTWriteRawData(SP_IN SP_HANDLE licHandle, 
											SP_IN SP_DWORD	featureID, 
...
SP_EXPORT SP_STATUS SP_API SFNTCounterDecrement(SP_IN SP_HANDLE	licHandle, 
												SP_IN SP_DWORD	featureID, 
												SP_IN SP_DWORD	decrementValue);

SP_EXPORT SP_STATUS SP_API SFNTEncrypt(SP_IN  SP_HANDLE	licHandle,
									   SP_IN  SP_DWORD	featureID, 
									   SP_IN  SPP_BYTE	plainBuffer,
									   SP_OUT SPP_BYTE	cipherBuffer
									   );

SP_EXPORT SP_STATUS SP_API SFNTDecrypt(SP_IN  SP_HANDLE	licHandle,			
									   SP_IN  SP_DWORD	featureID,	
									   SP_IN  SPP_BYTE	cipherBuffer,
									   SP_OUT SPP_BYTE	plainBuffer
									   );

SP_EXPORT SP_STATUS SP_API SFNTVerify(SP_IN SP_HANDLE	licHandle, 
									  SP_IN SPP_BYTE	publicKey, 
									  SP_IN SPP_BYTE	signBuffer, 
									  SP_IN SP_DWORD	length,
									  SP_IN SPP_BYTE	signResult);

SP_EXPORT SP_STATUS SP_API SFNTSign(SP_IN  SP_HANDLE	licHandle, 
									SP_IN  SP_DWORD		featureID, 
									SP_IN  SPP_BYTE		signBuffer, 
									SP_IN  SP_DWORD		length,
									SP_OUT SPP_BYTE		signResult);

SP_EXPORT SP_STATUS SP_API SFNTSetHeartbeat(SP_IN SP_HANDLE	licHandle, 
											SP_IN SP_DWORD	heartBeatValue);

SP_EXPORT SP_STATUS SP_API SFNTGetLicenseInfo(SP_IN SP_HANDLE			licHandle, 
											  SP_OUT SPP_LICENSE_INFO	licenseInfo); 

SP_EXPORT SP_STATUS SP_API SFNTGetFeatureInfo(SP_IN  SP_HANDLE			licHandle, 
											  SP_IN  SP_DWORD				featureID, 
											  SP_OUT SPP_FEATURE_INFO	featureInfo); 

SP_EXPORT SP_STATUS SP_API SFNTGetDeviceInfo(SP_IN SP_HANDLE			licHandle, 
											 SP_OUT SPP_DEVICE_INFO		deviceInfo);

SP_EXPORT SP_STATUS SP_API SFNTGetServerInfo(SP_IN SP_HANDLE		licHandle, 
											 SP_OUT SPP_SERVER_INFO serverInfo);

//SP_EXPORT SP_STATUS SP_API SFNTReleaseLicense(SP_IN SP_HANDLE		licHandle);
